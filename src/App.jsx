...
const SCENES = {
  hotel: {
    id: 'hotel',
    // NEW OneCompiler SVG Link
    backgroundMobile: 'https://uploads.onecompiler.io/44jjpumhc/1789609923816/1%20the%20hotel.svg',
    hitboxes: [
      ...GLOBAL_NAV_HITBOXES,
      // B & C ROOM Door Sign
  ...
  room: {
    id: 'room',
    // NEW OneCompiler SVG Link
    backgroundMobile: 'https://uploads.onecompiler.io/44jjpumhc/1789609916900/2%20the%20new%20pharoah%20black%20cat.svg',
    hitboxes: [
      ...GLOBAL_NAV_HITBOXES,
      // The Black Cat
  ...
  escape: {
    id: 'escape',
    // NEW OneCompiler SVG Link
    backgroundMobile: 'https://uploads.onecompiler.io/44jjpumhc/1789609903497/3%20the%20escape%20.svg',
    hitboxes: [
      ...GLOBAL_NAV_HITBOXES,
